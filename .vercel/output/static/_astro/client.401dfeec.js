    ...
    el = A({}, Gt, {
        ...
        movementX: function (e) {
            return "movementX" in e
                ...
                : (e !== pt &&
                      (pt && e.type === "mousemove"
                          ? ((Cl = e.screenX - pt.screenX),
                            (_l = e.screenY - pt.screenY))
                          : (_l = Cl = 0),
                      (pt = e)),
                  Cl);
        },
...
function wa(e, n, t) {
    return Nn & 21
        ? (Me(t, n) ||
              ((t = Es()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
          n)
...
function Cu(e, n, t, r, l, u) {
    ...
    return (
        (n.flags |= 1),
        e !== null && o
            ? ((n.child = et(n, e.child, null, u)),
              (n.child = et(n, null, i, u)))
            : le(e, n, i, u),
...
function Jf(e, n, t, r, l, u, o) {
    ...
    if (l.data === "$!") {
        ...
        return (
            (r = i), (u = Error(y(419))), (r = $l(u, r, void 0)), pr(e, n, o, r)
        );
    }
...
function td(e, n) {
    ...
    for (
        fu = { focusedElem: e, selectionRange: t }, Dr = !1, S = n;
        S !== null;
...
const Ed =
    ...
    (n, t, { default: r, ...l }, { client: u }) => {
        ...
        for (const [c, v] of Object.entries(l))
            t[c] = wn.createElement(Iu, { value: v, name: c });
        const i = wn.createElement(
                n,
                t,
        ...
        if ((s && delete e[s], u === "only"))
            return wn.startTransition(() => {
                const c = ba(e);
                c.render(i),
                    e.addEventListener("astro:unmount", () => c.unmount(), {
                        once: !0,
                    });
            });
        wn.startTransition(() => {
